...
def add_sale():
    customer = Sale(salesman_id=int(input("Enter id of salesman: ")), customer_id=int(input("Enter id of customer: ")), total=float(input("Enter total: ")))
...
def execute_queries():
    ...
    customer_id = int(input("Enter customer id: "))
    average_purchase = session.query(func.avg(Sale.total).label('average_purchase')).filter(Sale.customer_id == customer_id).scalar()
    ...
    salesman_id = int(input("Enter salesman id: "))
    average_purchase = session.query(func.avg(Sale.total).label('average_purchase')).filter(Sale.salesman_id == salesman_id).scalar()
